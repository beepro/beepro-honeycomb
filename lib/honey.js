...
function changeUpstream(honey, options) {
  return (0, _gitPromise2.default)('add .', options).then(function () {
    return (0, _gitPromise2.default)('commit -m "' + honey.commit.message + '"', options);
  }).then(function () {
    return (0, _gitPromise2.default)('push origin', options);
  });
}
...
function makeRC(honey) {
  ...
  _fsExtra2.default.writeFileSync(_path2.default.join(honey.path, '.beerc'), JSON.stringify(config), 'utf8');
