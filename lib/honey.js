...
function create(_ref) {
  var mongoose = _ref.mongoose,
      id = _ref.id,
      _ref$git = _ref.git;
  _ref$git = _ref$git === undefined ? {} : _ref$git;
  var gitUrl = _ref$git.url,
      branch = _ref$git.branch,
      _ref$commit = _ref.commit;
  _ref$commit = _ref$commit === undefined ? {} : _ref$commit;
  var message = _ref$commit.message,
      interval = _ref$commit.interval;
...
function changeUpstream(honey) {
  ...
  return (0, _gitPromise2.default)('add .', { cwd: honey.path }).then(function () {
    return (0, _gitPromise2.default)('commit -m "' + (honey.commit ? honey.commit.message : 'buzz buzz buzz') + '"', { cwd: honey.path });
  }).then(function () {
